...
print(10 * 'x', 'CIELO', 10 * 'x')
print('O valor Total da ANTECIPAÇÃO é de R$ %4.2f' % jurosTotal)
print('ANTECIPAÇÃO + ALUGUEL DA UM TOTAL DE R$ %4.2f' % totalGeral)
print('LUCRO NA VENDA PARCELADA COM ANTECIPAÇÃO R$ %4.2f' % (valor - jurosTotal))
#print('Seu LUCRO no final do mês é de R$ 4.2f' % (valor - totalGeral))
